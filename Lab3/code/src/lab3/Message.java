...
public class Message implements Serializable {
	...
	{
		return ("id:" + this.seqNum + ",source:" + this.src + ",destination:" + this.dest + ",kind:" + this.kind + ",data:" + this.data + ",duplication" + this.dupe);
	}
	public String toOrigString()
	{
		return ("id:" + this.seqNum + ",destination:" + this.dest + ",kind:" + this.kind + ",data:" + this.data + ",duplication" + this.dupe);
	}
